...
1. 手动编译bnb：请参考 bitsandbytes npu版本的[安装文档](https://huggingface.co/docs/bitsandbytes/installation?backend=Ascend+NPU&platform=Ascend+NPU#multi-backend-pip)或如下命令完成bnb的编译安装，编译要求环境cmake版本不低于3.22.1，g++版本不低于12.x
```
# 从源码安装bitsandbytes
